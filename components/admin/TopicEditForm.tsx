...
export default function TopicEditForm() {
  ...
  const loadTopic = async () => {
    try {
      setLoading(true);
      // For now, we'll use mock data since we don't have a getTopicById method
      // In a real app, you'd call AdminService.getTopicById(id)
  ...
  const handleSave = async () => {
    if (!canEdit) {
      Alert.alert('Permission Denied', 'You do not have permission to edit topics');
      return;
    }
    ...
    try {
      setSaving(true);
      // In a real app, you'd call AdminService.updateTopic(id, formData)
      console.log('Updating topic:', id, formData);
  ...
  const handleDelete = async () => {
    if (!canEdit) {
      Alert.alert('Permission Denied', 'You do not have permission to delete topics');
      return;
    }
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              setSaving(true);
              // In a real app, you'd call AdminService.deleteTopic(id)
